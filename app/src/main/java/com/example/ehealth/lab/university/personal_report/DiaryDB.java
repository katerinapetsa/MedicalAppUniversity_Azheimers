...
/**
 * Created by Stavroula Kousparou on 3/14/2019.
 */
...
public class DiaryDB {
    ...
    private EnumSet<Emotion> emotion;
    ...
    public DiaryDB(EnumSet<Emotion> emotion, int stressLevel, int menstruation, EnumSet<DiarySymptoms> symptoms, String comments, EnumSet<DiaryMoment> moment, EnumSet<BodyRegion> weakness){
    ...
    public EnumSet<Emotion> getEmotion(){
        return emotion;
    }
    public void setEmotion(EnumSet<Emotion> emotion){
        this.emotion = emotion;
    }
